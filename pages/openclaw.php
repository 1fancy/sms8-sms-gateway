...
{"@type":"Question","name":"How much does an SMS MCP for OpenClaw cost?","acceptedAnswer":{"@type":"Answer","text":"SMS8 is 29 USD per month flat after a free 5-day trial. There is no per-message fee because messages route through your own SIM, so the SMS cost is whatever your carrier already charges (often zero on an unlimited plan)."}},
...
<section class="section section-alt" id="faq">
  <div class="container">
    ...
    <div class="faq reveal">
      ...
      <details><summary>How much does an SMS MCP for OpenClaw cost?</summary><p>SMS8 is $29/month flat after a free 5-day trial. There is no per-message fee because messages route through your own SIM, so SMS cost is whatever your carrier already charges.</p></details>
